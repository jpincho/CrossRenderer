...
#undef CASE_TYPE_VEC
			...
			case ShaderUniformType::Block:
				...
				glUniformBlockBinding( ShaderInformation->OpenGLID, UniformInformation->OpenGLID, UniformBlockIndex );
				glBindBufferRange( GL_UNIFORM_BUFFER, UniformBlockIndex, SBInfo.OpenGLID, 0, SBInfo.DataSize );
				break;
				}
			default:
