...
#define GET_UNIFORM(VARIABLE,SHADER,NAME)\
        ...
        void SpecificImGuiDraw ( void )
            ...
            ImGui::Text ( "Light 1" );
            Light1Changed |= ImGui::InputFloat4 ( "Light 1 position", glm::value_ptr ( LightData[0].Position ) );
            Light1Changed |= ImGui::ColorPicker4 ( "Light 1 diffuse", glm::value_ptr ( LightData[0].Diffuse ) );
            Light1Changed |= ImGui::ColorPicker4 ( "Light 1 specular", glm::value_ptr ( LightData[0].Specular ) );
            Light1Changed |= ImGui::SliderFloat ( "Light 1 intensity", &LightData[0].Intensity, 0.0f, 200.0f );
            Light1Changed |= ImGui::SliderFloat ( "Light 1 const. atten.", &LightData[0].ConstantAttenuation, 0.0f, 200.0f );
            Light1Changed |= ImGui::SliderFloat ( "Light 1 linear atten.", &LightData[0].LinearAttenuation, 0.0f, 200.0f );
            Light1Changed |= ImGui::SliderFloat ( "Light 1 exp. atten.", &LightData[0].ExponentialAttenuation, 0.0f, 200.0f );

            bool Light2Changed = false;
            ImGui::Separator();
            ImGui::Text ( "Light 2" );
            Light2Changed |= ImGui::InputFloat4 ( "Light 2 position", glm::value_ptr ( LightData[1].Position ) );
            Light2Changed |= ImGui::ColorPicker4 ( "Light 2 diffuse", glm::value_ptr ( LightData[1].Diffuse ) );
            Light2Changed |= ImGui::ColorPicker4 ( "Light 2 specular", glm::value_ptr ( LightData[1].Specular ) );
            Light2Changed |= ImGui::SliderFloat ( "Light 2 intensity", &LightData[1].Intensity, 0.0f, 200.0f );
            Light2Changed |= ImGui::SliderFloat ( "Light 2 const. atten.", &LightData[1].ConstantAttenuation, 0.0f, 200.0f );
            Light2Changed |= ImGui::SliderFloat ( "Light 2 linear atten.", &LightData[1].LinearAttenuation, 0.0f, 200.0f );
            Light2Changed |= ImGui::SliderFloat ( "Light 2 exp. atten.", &LightData[1].ExponentialAttenuation, 0.0f, 200.0f );
            ImGui::End();
